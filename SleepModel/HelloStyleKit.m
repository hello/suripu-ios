...
//  Sense
//
//  Created by Delisa Mason on 8/6/15.
...
+ (UIImage*)playSound { return _playSound ?: (_playSound = [UIImage imageNamed: @"playSound"]); }
+ (UIImage*)pauseSound { return _pauseSound ?: (_pauseSound = [UIImage imageNamed: @"pauseSound"]); }
+ (UIImage*)timelineErrorIcon { return _timelineErrorIcon ?: (_timelineErrorIcon = [UIImage imageNamed: @"timelineErrorIcon"]); }
+ (UIImage*)timelineJustSleepIcon { return _timelineJustSleepIcon ?: (_timelineJustSleepIcon = [UIImage imageNamed: @"timelineJustSleepIcon"]); }
+ (UIImage*)timelineNoDataIcon { return _timelineNoDataIcon ?: (_timelineNoDataIcon = [UIImage imageNamed: @"timelineNoDataIcon"]); }
+ (UIImage*)timelineNotEnoughDataIcon { return _timelineNotEnoughDataIcon ?: (_timelineNotEnoughDataIcon = [UIImage imageNamed: @"timelineNotEnoughDataIcon"]); }
