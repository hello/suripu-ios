...
- (void)awakeFromNib
{
    ...
    self.lineView.image = [self lineBorderImageWithColor:[HelloStyleKit timelineTintTextColor]];
    self.eventTimeLabel.textColor = [HelloStyleKit timelineTintTextColor];
