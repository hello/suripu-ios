...
+ (void)drawSleepScoreGraphWithSleepScoreLabelText: (NSString*)sleepScoreLabelText sleepScore: (CGFloat)sleepScore;
{
    ...
    NSDictionary* sleepScoreTextLabelFontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"Calibre-Light" size: 10], NSForegroundColorAttributeName: veryDarkGrayColor, NSParagraphStyleAttributeName: sleepScoreTextLabelStyle};
