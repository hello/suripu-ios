...
- (void)drawMiniSleepScoreGraphWithSleepScore:(CGFloat)sleepScore sleepScoreHeight:(CGFloat)sleepScoreHeight
{
    ...
    UIColor* sleepScoreColor = sleepScore > 0 ? (sleepScore < 45 ? HelloStyleKit.warningSensorColor : (sleepScore < 80 ? HelloStyleKit.alertSensorColor : [HelloStyleKit idealSensorColor])) : sleepScoreNoValueColor;
