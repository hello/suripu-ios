...
//  Sense
//
//  Created by Delisa Mason on 11/17/15.
...
static UIImage* _attach = nil;
static UIImage* _playSound = nil;
static UIImage* _pauseSound = nil;
static UIImage* _timelineErrorIcon = nil;
static UIImage* _timelineJustSleepIcon = nil;
static UIImage* _timelineNoDataIcon = nil;
static UIImage* _timelineNotEnoughDataIcon = nil;
...
+ (void)initialize
{
    ...
    _backViewCardShadow = [NSShadow shadowWithColor: [HelloStyleKit.backViewCardShadowColor colorWithAlphaComponent: CGColorGetAlpha(HelloStyleKit.backViewCardShadowColor.CGColor) * 0.02] offset: CGSizeMake(0.1, 1.6) blurRadius: 0];
...
+ (UIColor*)sleepScoreOvalColor { return _sleepScoreOvalColor; }
...
+ (UIImage*)humidityIcon { return _humidityIcon ?: (_humidityIcon = [UIImage imageNamed: @"humidityIcon.png"]); }
+ (UIImage*)particleIcon { return _particleIcon ?: (_particleIcon = [UIImage imageNamed: @"particleIcon.png"]); }
+ (UIImage*)temperatureIcon { return _temperatureIcon ?: (_temperatureIcon = [UIImage imageNamed: @"temperatureIcon.png"]); }
+ (UIImage*)sense { return _sense ?: (_sense = [UIImage imageNamed: @"sense.png"]); }
+ (UIImage*)wifiIcon { return _wifiIcon ?: (_wifiIcon = [UIImage imageNamed: @"wifiIcon.png"]); }
+ (UIImage*)lockIcon { return _lockIcon ?: (_lockIcon = [UIImage imageNamed: @"lockIcon.png"]); }
+ (UIImage*)backIcon { return _backIcon ?: (_backIcon = [UIImage imageNamed: @"backIcon.png"]); }
+ (UIImage*)sensePlacement { return _sensePlacement ?: (_sensePlacement = [UIImage imageNamed: @"sensePlacement.png"]); }
+ (UIImage*)shakePill { return _shakePill ?: (_shakePill = [UIImage imageNamed: @"shakePill.png"]); }
+ (UIImage*)smartAlarm { return _smartAlarm ?: (_smartAlarm = [UIImage imageNamed: @"smartAlarm.png"]); }
+ (UIImage*)check { return _check ?: (_check = [UIImage imageNamed: @"check.png"]); }
+ (UIImage*)moon { return _moon ?: (_moon = [UIImage imageNamed: @"moon.png"]); }
+ (UIImage*)alarmBarIcon { return _alarmBarIcon ?: (_alarmBarIcon = [UIImage imageNamed: @"alarmBarIcon.png"]); }
+ (UIImage*)senseBarIcon { return _senseBarIcon ?: (_senseBarIcon = [UIImage imageNamed: @"senseBarIcon.png"]); }
+ (UIImage*)settingsBarIcon { return _settingsBarIcon ?: (_settingsBarIcon = [UIImage imageNamed: @"settingsBarIcon.png"]); }
+ (UIImage*)trendsBarIcon { return _trendsBarIcon ?: (_trendsBarIcon = [UIImage imageNamed: @"trendsBarIcon.png"]); }
+ (UIImage*)sensorsBarIcon { return _sensorsBarIcon ?: (_sensorsBarIcon = [UIImage imageNamed: @"sensorsBarIcon.png"]); }
+ (UIImage*)alarmSmartIcon { return _alarmSmartIcon ?: (_alarmSmartIcon = [UIImage imageNamed: @"alarmSmartIcon.png"]); }
+ (UIImage*)alarmSoundIcon { return _alarmSoundIcon ?: (_alarmSoundIcon = [UIImage imageNamed: @"alarmSoundIcon.png"]); }
+ (UIImage*)alarmRepeatIcon { return _alarmRepeatIcon ?: (_alarmRepeatIcon = [UIImage imageNamed: @"alarmRepeatIcon.png"]); }
+ (UIImage*)presleepInsightParticulates { return _presleepInsightParticulates ?: (_presleepInsightParticulates = [UIImage imageNamed: @"presleepInsightParticulates.png"]); }
+ (UIImage*)presleepInsightSound { return _presleepInsightSound ?: (_presleepInsightSound = [UIImage imageNamed: @"presleepInsightSound.png"]); }
+ (UIImage*)presleepInsightLight { return _presleepInsightLight ?: (_presleepInsightLight = [UIImage imageNamed: @"presleepInsightLight.png"]); }
+ (UIImage*)presleepInsightHumidity { return _presleepInsightHumidity ?: (_presleepInsightHumidity = [UIImage imageNamed: @"presleepInsightHumidity.png"]); }
+ (UIImage*)presleepInsightTemperature { return _presleepInsightTemperature ?: (_presleepInsightTemperature = [UIImage imageNamed: @"presleepInsightTemperature.png"]); }
+ (UIImage*)presleepInsightUnknown { return _presleepInsightUnknown ?: (_presleepInsightUnknown = [UIImage imageNamed: @"presleepInsightUnknown.png"]); }
+ (UIImage*)loading { return _loading ?: (_loading = [UIImage imageNamed: @"loading.png"]); }
+ (UIImage*)miniStopButton { return _miniStopButton ?: (_miniStopButton = [UIImage imageNamed: @"miniStopButton.png"]); }
+ (UIImage*)miniPlayButton { return _miniPlayButton ?: (_miniPlayButton = [UIImage imageNamed: @"miniPlayButton.png"]); }
+ (UIImage*)infoButtonIcon { return _infoButtonIcon ?: (_infoButtonIcon = [UIImage imageNamed: @"infoButtonIcon.png"]); }
+ (UIImage*)lightEventIcon { return _lightEventIcon ?: (_lightEventIcon = [UIImage imageNamed: @"lightEventIcon.png"]); }
+ (UIImage*)outOfBedEventIcon { return _outOfBedEventIcon ?: (_outOfBedEventIcon = [UIImage imageNamed: @"outOfBedEventIcon.png"]); }
+ (UIImage*)sunriseEventIcon { return _sunriseEventIcon ?: (_sunriseEventIcon = [UIImage imageNamed: @"sunriseEventIcon.png"]); }
+ (UIImage*)sleepEventIcon { return _sleepEventIcon ?: (_sleepEventIcon = [UIImage imageNamed: @"sleepEventIcon.png"]); }
+ (UIImage*)noiseEventIcon { return _noiseEventIcon ?: (_noiseEventIcon = [UIImage imageNamed: @"noiseEventIcon.png"]); }
+ (UIImage*)inBedEventIcon { return _inBedEventIcon ?: (_inBedEventIcon = [UIImage imageNamed: @"inBedEventIcon.png"]); }
+ (UIImage*)alarmEventIcon { return _alarmEventIcon ?: (_alarmEventIcon = [UIImage imageNamed: @"alarmEventIcon.png"]); }
+ (UIImage*)partnerEventIcon { return _partnerEventIcon ?: (_partnerEventIcon = [UIImage imageNamed: @"partnerEventIcon.png"]); }
+ (UIImage*)unknownEventIcon { return _unknownEventIcon ?: (_unknownEventIcon = [UIImage imageNamed: @"unknownEventIcon.png"]); }
+ (UIImage*)lightsOutEventIcon { return _lightsOutEventIcon ?: (_lightsOutEventIcon = [UIImage imageNamed: @"lightsOutEventIcon.png"]); }
+ (UIImage*)motionEventIcon { return _motionEventIcon ?: (_motionEventIcon = [UIImage imageNamed: @"motionEventIcon.png"]); }
+ (UIImage*)wakeupEventIcon { return _wakeupEventIcon ?: (_wakeupEventIcon = [UIImage imageNamed: @"wakeupEventIcon.png"]); }
+ (UIImage*)sunsetEventIcon { return _sunsetEventIcon ?: (_sunsetEventIcon = [UIImage imageNamed: @"sunsetEventIcon.png"]); }
+ (UIImage*)attach { return _attach ?: (_attach = [UIImage imageNamed: @"attach.png"]); }
+ (UIImage*)playSound { return _playSound ?: (_playSound = [UIImage imageNamed: @"playSound.png"]); }
+ (UIImage*)pauseSound { return _pauseSound ?: (_pauseSound = [UIImage imageNamed: @"pauseSound.png"]); }
+ (UIImage*)timelineErrorIcon { return _timelineErrorIcon ?: (_timelineErrorIcon = [UIImage imageNamed: @"timelineErrorIcon.png"]); }
+ (UIImage*)timelineJustSleepIcon { return _timelineJustSleepIcon ?: (_timelineJustSleepIcon = [UIImage imageNamed: @"timelineJustSleepIcon.png"]); }
+ (UIImage*)timelineNoDataIcon { return _timelineNoDataIcon ?: (_timelineNoDataIcon = [UIImage imageNamed: @"timelineNoDataIcon.png"]); }
+ (UIImage*)timelineNotEnoughDataIcon { return _timelineNotEnoughDataIcon ?: (_timelineNotEnoughDataIcon = [UIImage imageNamed: @"timelineNotEnoughDataIcon.png"]); }
