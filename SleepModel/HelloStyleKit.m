...
//  Sleep Sense
//
//  Created by Delisa Mason on 9/15/14.
...
+ (void)drawSleepScoreGraphWithSleepScoreLabelText: (NSString*)sleepScoreLabelText sleepScore: (CGFloat)sleepScore;
{
    ...
    NSDictionary* sleepScoreTextLabelFontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"Agile-Medium" size: 11], NSForegroundColorAttributeName: UIColor.grayColor, NSParagraphStyleAttributeName: sleepScoreTextLabelStyle};
