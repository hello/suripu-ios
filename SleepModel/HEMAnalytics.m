...
NSString* const kHEMAnalyticsEventOnBWiFiScan = @"Onboarding WiFi Scan"; // fires when app auto starts a scan
NSString* const kHEMAnalyticsEventOnBWiFiRescan = @"Onboarding WiFi Rescan"; // fires when user triggers a scan
