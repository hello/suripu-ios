...
//  Sleep Sense
//
//  Created by Delisa Mason on 10/15/14.
...
+ (void)initialize
{
    ...
    _purple = [UIColor colorWithRed: 0.478 green: 0.031 blue: 0.976 alpha: 1];
...
+ (void)drawSleepScoreGraphWithSleepScoreLabelText: (NSString*)sleepScoreLabelText sleepScore: (CGFloat)sleepScore;
{
    ...
    CGRect sleepScoreLabelRect = CGRectMake(0, 25, 123, 98);
