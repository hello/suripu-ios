...
/**
 *  NSArray of NSDictionaries containing the keys 'label' and 'value' which represent the section
 *  headings within the graph
 */
...
/**
 *  Returns the color of a particular line's fill within the chart
 *
 *  Default: clear color
 *
 *  @param lineChartView    The line chart object requesting this information.
 *  @param lineIndex        An index number identifying a line in the chart.
 *
 *  @return The color to be used for the line fill
 */
