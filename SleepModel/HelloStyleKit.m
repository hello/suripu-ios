...
//  Sleep Sense
//
//  Created by Delisa Mason on 4/8/15.
...
static UIImage* _sensorLoader = nil;
...
+ (UIImage*)sensorLoader { return _sensorLoader ?: (_sensorLoader = [UIImage imageNamed: @"sensorLoader"]); }
...
+ (void)drawBreakdownWithSleepScore: (CGFloat)sleepScore controlSize: (CGFloat)controlSize
{
    ...
    CGFloat fontSize = controlSize / 144.0 * 65 - (controlSize < 100 ? 1 : 0);
