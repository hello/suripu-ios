...
//  Sleep Sense
//
//  Created by Delisa Mason on 2/4/15.
...
+ (void)initialize
{
    ...
    _separatorColor = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.1];
    ...
    _settingsValueTextColor = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.3];
